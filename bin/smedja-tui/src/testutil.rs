//! Shared test-only helpers (constructing `AppState`, rendering frames).
use crate::render::render;
use crate::state::{AppState, InputMode, PanelVisibility};
use crate::{
    action_log, blocks, main_panel, metrics_view, obs_panel, quality_panel, staging, value_panel,
};
