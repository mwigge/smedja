//! Application state: the `AppState` god-struct and its immediate data model.
//!
...
pub(crate) struct AppState {
    ...
    pub(crate) quality_score_count: u64,
