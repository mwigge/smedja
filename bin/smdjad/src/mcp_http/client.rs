//! Minimal JSON-RPC 2.0 client for MCP HTTP servers (`tools/*` methods).

use tokio::sync::OnceCell;

use super::notifications::negotiate_protocol_version;
use super::types::{McpTool, MCP_PROTOCOL_VERSIONS};
