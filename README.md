...
The assayer routes by **role + complexity**, not just complexity. A straightforward fix stays local; an architecture review goes to claude deep. No manual model selection per task.
