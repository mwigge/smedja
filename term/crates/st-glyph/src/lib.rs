//! `st-glyph` — glyph shaping utilities for smedja-term.
//!
//! This crate re-exports the glyph atlas and shelf packer from `st-render`
//! so other crates can reference glyph metrics without depending on the full
//! renderer.  Standalone shaping helpers are added here as needed.
