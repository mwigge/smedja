//! The per-frame redraw handler.
//!
//! Extracted from the `RedrawRequested` arm of the window-event dispatcher:
//! uploads dirty cells, evaluates the status bar modules, updates the window
//! title and agent-block overlay, and presents the frame.
...
use crate::app::App;
use crate::render::{build_window_title, render_cell, tier_badge_text};
